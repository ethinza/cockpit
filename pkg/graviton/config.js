 ...
 */
export const INSTALL_SH = '/usr/share/ethinza/graviton/install.sh';
export const GRAVITON_EXE = '/usr/share/ethinza/graviton';

// export const graviton_CONF_FILE = '/etc/cockpit/machines-ovirt.config'; // relative URL for async download
export const VDSM_CONF_FILE = '/etc/vdsm/vdsm.conf';
export const PEM_FILE = '/etc/pki/vdsm/certs/cacert.pem';
export const GRAVITON_DEFAULT_PORT = 443;
...
const Config = {
    ...
    OvirtFqdn: 'engine.graviton.ethinza',
    OvirtPort: 443,

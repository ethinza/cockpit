...
import $ from "jquery";
import Config, { GRAVITON_EXE } from "./config.js";
...
function main() {
    ...
    output.text("Trying helper " + GRAVITON_EXE);
}
...
function helperRun() {
    ...
    proc.done(gravitonSuccess);
    proc.stream(gravitonOutput);
    proc.fail(gravitonFail);
}

function gravitonSuccess() {
    result.css("color", "green");
    result.text("success");
}

function gravitonFail() {
    result.css("color", "red");
    result.text("fail");
}

function gravitonOutput(data) {
